...
export const SCREENS = {
  home: { file: '/screens/home.html?v=3', label: 'Home', icon: 'home', tab: 'home' },
  ...
  welfare: { file: '/screens/welfare.html?v=2', label: 'Yojana Saathi', icon: 'volunteer_activism', tab: 'services' },
  ...
  'scheme-scanner': { file: '/screens/scheme-scanner.html?v=2', label: 'Scheme Scanner', icon: 'qr_code_scanner', tab: 'services' },
  'xray-tracker': { file: '/screens/xray-tracker.html', label: 'Bureaucracy X-Ray', icon: 'track_changes', tab: 'track' },
  community: { file: '/screens/community.html?v=2', label: 'Community Impact', icon: 'groups', tab: 'community' },
